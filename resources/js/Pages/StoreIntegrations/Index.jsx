            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                        ...
                        {/* Check for can?.create_integration with optional chaining and default to true if undefined */}
                        {(can?.create_integration !== false) && (
                            <Link 
                                href="/store-integrations/create" 
                                className="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md shadow-sm transition-colors flex items-center whitespace-nowrap text-sm sm:text-base w-full sm:w-auto justify-center sm:justify-start"
                            >
                    ...
                    {integrations.length === 0 ? (
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="p-10 text-center">
                                ...
                                {/* Always render the button if can is truthy, default to true if can is undefined */}
                                {(can?.create_integration !== false) && (
                                    <Link 
                                        href="/store-integrations/create" 
